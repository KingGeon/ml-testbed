...
class CWRU(Dataset):
    def __init__(
        ...
        ball_dataset, b_len = self._load_fault_dataset('ball')
    ...
    def _download_outer_race_fault_data(self):
        ...
        start_index_list = [130, 144, 246, 156, 258, 294, 298, 302]
        positions = ['DE', 'DE', 'DE', 'DE', 'DE', 'FE', 'FE', 'FE']
        diameters = [7, 7, 21, 7, 21, 7, 7, 7]
        locations = ['Center', 'Orthogonal', 'Orthogonal', 'Opposite', 'Opposite', 'Center', 'Orthogonal', 'Opposite']
