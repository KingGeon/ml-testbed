...
class ProtoNetModule(LightningModule):
    ...
    def setup(self, stage=None):
        ...
        if stage == 'fit' or stage is None:
            model_weights_path = '/home/geon/dev_geon/ml-testbed/src/models/components/ProtoNet_no_mixup_no_embedding.pth'
    ...
    def test_step(self, batch, batch_idx):
        ...
        torch.save(self.net.state_dict(), '/home/geon/dev_geon/ml-testbed/src/models/components/ProtoNet_no_mixup_no_embedding.pth')
