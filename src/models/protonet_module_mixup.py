...
class ProtoNetModule(LightningModule):
    def __init__(self,
        ...
        self.max_beta = 0.4      # 최대 beta 값
        self.epochs_to_max = 25
    ...
    def setup(self, stage=None):
        ...
        if stage == 'fit' or stage is None:
            model_weights_path = '/home/geon/dev_geon/ml-testbed/src/models/components/ProtoNet_mixup_no_embedding.pth'
    ...
    def training_step(self, batch, batch_idx):
        ...
        """
        # 전체 손실
        total_loss =   (1-beta) * classification_loss + beta * mixedup_classification_loss_1 # 0.25*mixedup_classification_loss_1 + 0.25*mixedup_classification_loss_2 + 0.25*mixedup_classification_loss_3 + 0.25*mixedup_classification_loss_4
    ...
    def test_step(self, batch, batch_idx):
        ...
        torch.save(self.net.state_dict(), '/home/geon/dev_geon/ml-testbed/src/models/components/ProtoNet_mixup_no_embedding.pth')
